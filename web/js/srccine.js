        ...
        $.getJSON("http://api.themoviedb.org//3/movie/"+idPelicula+"/trailers?api_key=05c9544702dc546bbe3cac04d5e55356", 
            function(json) {
                if (json.youtube.length >0 ){
                    document.getElementById("trailer"+id).src = "//www.youtube.com/embed/"+
                            json.youtube[0].source;
                }else{
    ...
    function validarLogin(){
        if(document.getElementById('usuario').value.length!==0 && document.getElementById('clave').
                value.length!==0){
