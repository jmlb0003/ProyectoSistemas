...
public class DAOPelicula {
    ...
    public List get(String titulo) {
        ...
        Query consulta = em.createQuery("SELECT p FROM Pelicula p Where p._titulo LIKE '%"+
                titulo+"%' ORDER BY p._media DESC");
    ...
    public List getMejorValoradas() {
        ...
        Query consulta = em.createQuery("SELECT p FROM Pelicula p ORDER BY p._media DESC LIMIT "+
                srccine.modelo.Modelo.NUM_RECOMENDACIONES);        
        return consulta.getResultList();
    }
